...
public:
	...
	f32 _AB8;                            // _AB8, some sort of whistle state timer?
	int mWhistleState;                   // _ABC, 0 is not whistling, 1 is partial size, 2 is full size
	f32 _AC0;                            // _AC0, some sort of whistle size with 1 being full size
	f32 _AC4;                            // _AC4
